...
perrine_1 = Plant.create!(
  ...
  repot_interval: 365,
  mood_points: 40,
  last_watered: Date.new(2026, 3, 10),
...
perrine_2 = Plant.create!(
  ...
  repot_interval: 548,
  mood_points: 75,
  last_watered: Date.new(2026, 3, 17),
  last_petting: Date.new(2026, 3, 13)
)
...
perrine_4 = Plant.create!(
  ...
  mood_points: 85,
  last_watered: Date.new(2026, 2, 25),
  last_repot: Date.new(2024, 6, 1),
  last_petting: Date.new(2026, 3, 10)
)

perrine_5 = Plant.create!(
  user: perrine,
  nickname: "Velvet",
  common_name: "African Violet",
  scientific_name: "Saintpaulia ionantha",
  ...
  mood_points: 60,
  last_watered: Date.new(2026, 3, 15),
  last_repot: Date.new(2024, 10, 5),
  last_petting: Date.new(2026, 3, 16)
)

perrine_6 = Plant.create!(
  user: perrine,
  nickname: "Dracula",
  common_name: "ZZ Plant",
  scientific_name: "Zamioculcas zamiifolia",
...
[monstera_manon, golden_pothos, ficus, monstera_bob, habib_1, habib_2, habib_3,
 ...
 perrine_1, perrine_2, perrine_3, perrine_4, perrine_5, perrine_6, perrine_7, perrine_8].each do |plant|
